...
public class ApkSigningBlockUtils {
    ...
    public record SupportedSignature(SignatureAlgorithm algorithm, byte[] signature) {
    }

    public record SigningSchemeBlockAndDigests(Pair<byte[], Integer> signingSchemeBlock,
